...
public class Item {
    ...
    public static Item[] ALL_ITEMS = new Item[] {
            ...
            new Item("冰霜长矛",  R.drawable.weapon_frost,    R.id.item_weapon, 1970,  500,  80,   0,   0,   0,   0, 0,    0,    0,    0),
            ...
            new Item("贪婪之噬",  R.drawable.mob_attack,      R.id.item_mob,    1460,    0,  45,   0,   0,   0,   0, 0.12, 0,    0,    0),
