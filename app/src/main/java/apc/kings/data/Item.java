...
public class Item {
    ...
    public static final Item[] ALL_ITEMS = new Item[] {
            ...
            new Item("无尽战刃",  R.drawable.weapon_critical,   R.id.item_weapon, 2140,    0, 100,   0,   0,   0,   0,  0, 20,  0, FLAG_CRITICAL),
            new Item("冰霜长矛",  R.drawable.weapon_frost,      R.id.item_weapon, 1970,  500,  80,   0,   0,   0,   0,  0,  0,  0, FLAG_FROST),
            new Item("名刀·司命",R.drawable.weapon_curtain,    R.id.item_weapon, 1760,    0,  60,   0,   0,   0,   0,  0,  0,  5, 0),
